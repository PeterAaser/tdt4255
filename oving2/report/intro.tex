...
As the work underlying this report ties closely to the work we did in the previous exercise.
...
Pipelined processing introduces data and control hazard, so it is also required to implement systems for dealing with this.
...
As we did last time, we started by making architecture level sketches of the changes that had to be made to the data-/controlpaths before we started writing VHDL code.
Having planned our next moves while sketching, we started implementing the modified design in VHDL and verifying it with gradually more complex testbenches.
