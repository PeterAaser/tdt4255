...
Apart from the register file, the state of the system is held in pipeline registers. In \ref{fig:toplevel} these are shown as pillars.
...
To stop this from happening we must stall the first of the add instructions as shown in \ref{fig:hazard2} 
