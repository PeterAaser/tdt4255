...
The state of the processor is held in the state registers between each stage. Apart from these registers the only state in the processor is held in the program counter, register file, data memory and instruction memory.
